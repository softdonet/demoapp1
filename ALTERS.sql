...
CREATE  TABLE almacen.tbl_datos_adicionales_producto_venta(
...
alter table almacen.tbl_producto add column solicitadatosadicionales boolean default false;
alter table creditos.tbl_detpagocuota add column imp_pago_cuota numeric(20,4) default 0;

alter table ventas.tbl_cotizacionpreventa add column status boolean;
alter table planillas.tbl_persona add column phone_number text;
alter table ventas.tbl_detfacturacion add  column costo numeric(20,6) default 0;


alter table ventas.tbl_cotizacionpreventa add column x_destination numeric(20,12) default 0;
alter table ventas.tbl_cotizacionpreventa add column y_destination numeric(20,16) default 0;
alter table ventas.tbl_cotizacionpreventa add column  delivery_amount numeric(20,16) default 0;

CREATE TABLE common.delivery_type
(
    id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    uuid character varying(36) COLLATE pg_catalog."default" NOT NULL DEFAULT upper((uuid_in((md5(((random())::text || (now())::text)))::cstring))::text),
    name character varying(50) COLLATE pg_catalog."default" NOT NULL,
    label character varying(100) COLLATE pg_catalog."default" NOT NULL,
    status boolean DEFAULT true,
    CONSTRAINT deliver_type_pk PRIMARY KEY (id)
);

CREATE TABLE seguridad.user_type
(
    id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    uuid character varying(36) COLLATE pg_catalog."default" NOT NULL DEFAULT upper((uuid_in((md5(((random())::text || (now())::text)))::cstring))::text),
    name character varying(50) COLLATE pg_catalog."default" NOT NULL,
...
CREATE TABLE seguridad.login_type
(
    id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    uuid character varying(36) COLLATE pg_catalog."default" NOT NULL DEFAULT upper((uuid_in((md5(((random())::text || (now())::text)))::cstring))::text),
    name character varying(40) COLLATE pg_catalog."default" NOT NULL,
    label character varying(40) COLLATE pg_catalog."default" NOT NULL,
    status boolean DEFAULT true,
    CONSTRAINT login_type_pk PRIMARY KEY (id)
);
alter table common.tbl_empresa add column date_update timestamp;
alter table seguridad.tbl_usuario add column id_empresa integer default 1;
CREATE TABLE planillas.tbl_coordinatehistory
(
    id bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1 ),
    user_id varchar(5) NOT NULL,
    order_id bigint,
    date_insert timestamp without time zone NOT NULL,
    coddia integer NOT NULL,
    x numeric(16,12) NOT NULL,
    y numeric(16,12) NOT NULL,
    CONSTRAINT coordinate_history_pk PRIMARY KEY (id),
    CONSTRAINT coordinate_history_user FOREIGN KEY (user_id)
        REFERENCES seguridad.tbl_usuario (id_usuario) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
);
...
alter table common.tbl_empresa add column correo_ssl boolean default false;
...
select *from almacen.v_productosalmacen where disponible::numeric>0
